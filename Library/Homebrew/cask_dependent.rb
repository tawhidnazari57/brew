...
class CaskDependent
  ...
  sig { returns(T::Array[T.any(Requirement, ArchRequirement, CaskDependent::Requirement)]) }
  def requirements
    @requirements ||= T.let(
      begin
        requirements = []
      ...
      T.nilable(T::Array[T.any(Requirement, ArchRequirement, CaskDependent::Requirement)])
    )
  end

  sig { params(block: T.proc.returns(T.anything)).returns(T::Array[Dependency]) }
  def recursive_dependencies(&block)
    Dependency.expand(self, &block)
  end

  sig { params(block: T.proc.returns(T.anything)).returns(T::Array[Requirement]) }
